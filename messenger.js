(function () {
  ...
  .msg-system { text-align: center; font-size: 11px; color: var(--color-text-tertiary, #6f7380); margin: 12px 0; line-height: 1.5; }
  ...
  var log = [
    ...
    { who: 'seraph', text: '삐졌어? 왜 이렇게 예민하게 굴어. 그날이냐?', time: '15:47' },
  ...
  log.forEach(function (m) {
    ...
    if (m.system) {
      ...
      prevWho = null; // 시스템 로그 다음엔 아바타/이름 다시 표시
      prevName = null;
      return;
    }
